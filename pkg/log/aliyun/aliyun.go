...
import (
	...
	alisdk "github.com/aliyun/aliyun-log-go-sdk"
...
func (a *aliyunLog) Log(level log.Level, keyvals ...interface{}) error {
	contents := make([]*alisdk.LogContent, 0, len(keyvals)/2+1)

	contents = append(contents, &alisdk.LogContent{
...
func NewAliyunLog(options ...Option) Logger {
	...
	producerConfig.AllowLogLevel = opts.level
	producerConfig.CredentialsProvider = alisdk.NewStaticCredentialsProvider(opts.accessKey, opts.accessSecret, "")
